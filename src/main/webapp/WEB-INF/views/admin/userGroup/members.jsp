...
<spring:url var="addUserAsMemberUrl" value="/admin/userGroup/{id}/members/add">
    <spring:param name="id" value="${userGroup.id}"/>
</spring:url>
<spring:url var="removeUserFromMembersUrl" value="/admin/userGroup/{id}/members/delete">
    <spring:param name="id" value="${userGroup.id}"/>
</spring:url>
...
<html>
    ...
    <body>
        <page:header text="userGroup.members.header"/>
